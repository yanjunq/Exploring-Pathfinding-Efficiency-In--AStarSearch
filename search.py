...
def breadth_first_graph_search(problem):
    ...
    while frontier:
        ...
        for child in node.expand(problem):
            ...
            # if tuple(child.state) not in explored or frontier:
            if tuple(child.state) not in explored and all(tuple(i.state) != tuple(child.state) for i in frontier):
                if problem.goal_test(child.state):
                    # print(len(explored), child.path_cost)
                    return child, explored
                frontier.append(child)
                
    # print(len(explored), 0)           
